...
public class ModeloItemCarritoTest {
    ...
    public void testCrearItemValido() {
        ModeloItemCarrito item = new ModeloItemCarrito(1, "Producto Test", 10.0, 2, 20.0);
    ...
    public void testCantidadCeroLanzaExcepcion() {
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            new ModeloItemCarrito(1, "Producto", 10.0, 0, 0.0);
    ...
    public void testCantidadNegativaLanzaExcepcion() {
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            new ModeloItemCarrito(1, "Producto", 10.0, -5, -50.0);
    ...
    public void testInmutabilidad() {
        ...
        ModeloItemCarrito item = new ModeloItemCarrito(1, "Producto", 10.0, 2, 20.0);
        assertEquals(1, item.getIdProducto());
    ...
    public void testEquals() {
        ModeloItemCarrito item1 = new ModeloItemCarrito(1, "Producto", 10.0, 2, 20.0);
        ModeloItemCarrito item2 = new ModeloItemCarrito(1, "Producto", 10.0, 2, 20.0);
    ...
    public void testItemsDiferentesNoSonIguales() {
        ModeloItemCarrito item1 = new ModeloItemCarrito(1, "Producto A", 10.0, 2, 20.0);
        ModeloItemCarrito item2 = new ModeloItemCarrito(2, "Producto B", 15.0, 3, 45.0);
